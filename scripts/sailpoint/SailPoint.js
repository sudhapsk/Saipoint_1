...
SailPoint.resetTimeout = function() {
    // We have two competing timeout mechanisms the classic jsf implementation and the new angular implementation.
    // Check to see if the page includes angular and the sailpoint.timeout module exists.  If yes then
    // short circuit the jsf implementation.
