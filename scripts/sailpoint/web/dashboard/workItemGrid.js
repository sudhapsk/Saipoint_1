        ...
        var leftAttributes = [ {
            ...
            items : [ {
                ...
                items : [ {
                    ...
                    endDateField: gridName + 'frmExpirationEndDate' 
                } ]
            }, {
                xtype : 'form',
                fieldDefaults : {
                ...
                items : [ {
                    ...
                    startDateField: gridName + 'frmExpirationStartDate'
                } ]
            } ]
        }, {
            xtype : 'container',
            ...
            items : [ {
                ...
                items : [ {
                    ...
                    endDateField: gridName + 'frmWakeUpEndDate'
                } ]
            }, {
                layout : 'anchor',
                fieldDefaults : {
                ...
                items : [ {
                    ...
                    startDateField: gridName + 'frmWakeUpStartDate'
                } ]
            } ]
        }, {
            xtype : 'container',
