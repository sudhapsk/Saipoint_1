...
Ext.define('SailPoint.roles.AutomatedDirectedMiningPanel', {
        ...
        Ext.apply(this, {
            ...
            bbar: [{
                ...
                handler: function() {
                    ...
                    if(validated) {
                        var miningBtn = Ext.getDom('automatedDirectedMiningForm:launchITRoleMining');
                        miningBtn.click();
                    } else {
                ...
                handler: function() {
                    Ext.getDom('automatedDirectedMiningForm:automatedMiningViewLastTaskResult').click();
                }
            },{
    ...
    applyEntitlementCreationOptions: function() {
        ...
        var currentRow;
        var i;
        var creationSettingsTable = Ext.getDom('creationSettingsTbl');
        var messagesToShow;
        var messagesToHide;
    ...
    applyFilterCreationOptions: function() {
        ...
        var currentRow;
        var i;
        var creationSettingsTable = Ext.getDom('miningSettingsTbl');
        var messagesToShow;
        var messagesToHide;
        ...
        if (selectedValue == 'identityFilter') {
            ...
            var addFilterBtn = Ext.getDom('automatedDirectedMiningForm:automatedMiningaddFilterBtn');
    ...
    validateAutomatedDirectedMiningSelections: function() {
        ...
        if (creationOption == 'createNewRole') {
            ...
            // Check for name
            var newRoleName = Ext.getDom('automatedDirectedMiningForm:automatedDirectedMiningNewRoleName').value;
            ...
            // Check type
            var selectedType = Ext.getDom('automatedDirectedMiningForm:automatedDirecteMiningNewRoleType').value;
        ...
        if (creationOption == 'groupFilters') {
            ...
            // Check for groups
            var groups = Ext.getDom('automatedDirectedMiningGroupSuggest').value;
            ...
            var identityFilter;
            if (Ext.getDom('automatedDirectedMiningForm:automatedMiningfilterSourceArea'))
                identityFilter = Ext.getDom('automatedDirectedMiningForm:automatedMiningfilterSourceArea').value;
            else
                identityFilter = Ext.getDom('automatedDirectedMiningForm:automatedMiningfilterSourceInput').value;
        ...
        var applications = Ext.getDom('automatedMiningApplicationSuggest').value;
        ...
        var percentageThreshold = Number(Ext.getDom('automatedDirectedMiningForm:autoDirectedMiningThresholdPercentage').value);
    ...
    displayLaunchStatus: function() {
        var launchResults = Ext.getDom('launchResultContents').innerHTML;
        Ext.MessageBox.alert('#{msgs.title_automated_mining}', launchResults);
    },
    
    displaySaveStatus: function() {
      var saveResults = Ext.getDom('automatedSaveResultContents').innerHTML;
    ...
    this.getLoader().load({
      ...
      callback: function() {
          SailPoint.roles.directedMiningExistingRoleSuggest = new SailPoint.BaseSuggest({
              ...
              applyTo: Ext.getDom('automatedMiningExistingRoleSuggest'),
              binding: Ext.getDom('automatedDirectedMiningForm:automatedMiningExistingRole'),
              allowBlank: true,
          ...
          new SailPoint.IdentitySuggest({
              ...
              applyTo: Ext.getDom('automatedDirectedMiningRoleOwnerSuggest'),
              binding: Ext.getDom('automatedDirectedMiningForm:automatedDirectedMiningNewRoleOwner'),
              allowBlank: false,
          ...
          SailPoint.roles.directedMiningContainerRoleSuggest = new SailPoint.BaseSuggest({
              ...
              applyTo: Ext.getDom('automatedMiningContainerRoleSuggest'),
              binding: Ext.getDom('automatedDirectedMiningForm:automatedMiningContainerRole'),
              allowBlank: true,
          ...
          SailPoint.roles.groupsMultiSuggest = new SailPoint.MultiSuggest({
              ...
              suggestType: 'group',
              jsonData: JSON.parse(Ext.getDom('automatedDirectedMiningGroupMultiSuggestData').innerHTML),
          ...
          SailPoint.roles.automatedDirectedMiningAppsMultiSuggest = new SailPoint.MultiSuggest({
              ...
              jsonData: JSON.parse(Ext.getDom('automatedDirectedMiningApplicationMultiSuggestData').innerHTML),
          ...
          buildTooltips(Ext.getDom('automatedDirectedMiningPanel'));
...
SailPoint.roles.saveITTemplatePrompt = function(btn, text) {
  ...
  var templateName = Ext.getDom('automatedDirectedMiningForm:itRoleMiningTemplateName').value;
  var originalTemplateName = Ext.getDom('automatedDirectedMiningForm:itRoleMiningOriginalTemplateName').value;
  ...
  if(panel.templateId) {
    if(!saveWindow) {
      ...
      updateField.on('check', function(checkbox){
        if(checkbox.checked) {
          Ext.get('itWindowTemplateNameLabel').setVisibilityMode(Ext.Element.DISPLAY).hide();
          Ext.get('itWindowTemplateName').setVisibilityMode(Ext.Element.DISPLAY).hide();
        }
      });
      ...
      Ext.getDom('itWindowTemplateSaveUpdate').nextSibling.innerHTML = Ext.String.format('#{msgs.role_mining_template_update}', originalTemplateName);
    }
...
SailPoint.roles.saveITTemplate = function(btn, text) {  
  ...
  if(btn=="ok") {
    Ext.getDom('automatedDirectedMiningForm:itRoleMiningTemplateId').value = '';
    Ext.getDom('automatedDirectedMiningForm:itRoleMiningTemplateName').value = text;
    Ext.getDom('automatedDirectedMiningForm:itSaveTemplateBtn').click();
  } else if(btn=="update"){
    Ext.getDom('automatedDirectedMiningForm:itSaveTemplateBtn').click();
  }
};
...
SailPoint.roles.getAutomatedDirectedMiningCreationOption = function(type) {
    var inputEl;
    if (type == 'entitlement')
        inputEl = Ext.getDom('automatedDirectedMiningForm:entitlementCreationOption');
    else
        inputEl = Ext.getDom('automatedDirectedMiningForm:filterCreationOption');
