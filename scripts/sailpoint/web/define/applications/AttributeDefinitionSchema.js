        ...
        bbar: [
            {
                ...
                handler: function() {
                    ...
                    Ext.getDom('editForm:attributeDefinitionJSON').value = Ext.JSON.encode(f.getFieldValues());
                    Ext.getDom('editForm:attributeDefinitionUpdateBtn').click();
...
SailPoint.define.applications.setSchemaProperty = function(property) {
    ...
    Ext.getDom('editForm:schemaPropertyJSON').value = Ext.JSON.encode(model.getData());
    Ext.getDom('editForm:schemaPropertyUpdateBtn').click();
};
