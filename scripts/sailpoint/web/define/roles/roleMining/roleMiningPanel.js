...
Ext.define('SailPoint.Role.ITRoleMiningPanel', {
    ...
    initMiningIpopSelector: function() {
        var ipopNameInput = Ext.DomQuery.selectNode('option[selected=selected]', Ext.getDom('scheduleItRoleMiningForm:ipopName'));
        var ipopVal;
    ...
    updateIpopDescription: function(ipop) {
        var ipopsInfo = JSON.parse(Ext.getDom('itRoleMiningIpopsInfo').innerHTML);
