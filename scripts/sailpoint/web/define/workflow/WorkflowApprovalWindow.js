Ext.define('SailPoint.WorkflowApprovalWindow', {
    ...
    savenohide : function () {
        ...
        // bug#24376 - Click Close button on a Form Editor automatically add the form to the workflow step in Business Process workflow.
        // noticed this is happening on approval steps too. Only set the approvalObj.id when you are about to save, not when initializing
        // the WorkflowApprovalWindow component.
        if(!this.approvalObj.id) {
