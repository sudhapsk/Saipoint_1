...
SailPoint.Manage.Certification.showRescindChildCertificationWindow = function(certId) {
    ...
    SailPoint.confirm(
        ...
        { windowParameters: {className: 'sailpoint',
          ...
          ok:function(win) {
              Ext.getDom('editForm:certId').value = certId;
              Ext.getDom('editForm:rescindBtn').click();
              return false;
          },
...
SailPoint.Manage.Certification.afterRescindCheck = function() {
    ...
    if(errorDiv) {
        ...
        if(!formError || !formError.elements.length) {
            ...
            Ext.get('rescindingProgressDiv').setVisibilityMode(Ext.Element.DISPLAY).hide();
...
SailPoint.Manage.Certification.afterRescindChildCertification = function() {
    ...
    if (Ext.get('editForm:rerenderSummaryBtn'))
        Ext.getDom('editForm:rerenderSummaryBtn').click();
};
