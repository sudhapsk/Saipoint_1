...
SailPoint.workitem.showPriorityEditor = function(grid, workItemId, level, cell) {
    ...
    var dialogCt = Ext.getDom('priorityEditorDialogCt');
    ...
    if (!priorityEditorDialog) {
        priorityEditorDialog = new Ext.Window({
            ...
            buttons: [{
                ...
                handler: function(button, eventObj) {
                    Ext.getDom('priorityEditForm:updatePriorityBtn').click();
                }
            },{
        ...
        Ext.getDom('id').value = workItemId;
        Ext.getDom('priorityEditForm:prioritySelection').value = level;
...
SailPoint.workitem.ApprovalItemGrid.persistDecisions = function( workitemId, decisions, bulkDecision ) {
    ...
    Ext.getDom('editForm:decisions').value = decisions;
    Ext.getDom('editForm:bulkDecision').value = bulkDecision;
