...
SailPoint.LCM.ManageDeletedObjects.DisplayDeletedObjects = {
    ...
    callRestore: function (selectUserId, selectedGrpId) {
        Ext.getDom('editForm:accountSelectedIds').value = arrayToString(selectUserId, false);
        Ext.getDom('editForm:groupSelectedIds').value = arrayToString(selectedGrpId, false);
        Ext.getDom('editForm:selectedApplicationId').value = SailPoint.LCM.ManageDeletedObjects.selectedAppId;
        Ext.getDom("editForm:restoreCmdBtn").click();
    },
