...
Ext.define('SailPoint.LCM.AvailableIdentitiesGrid', {
  ...
  search : function(vals) {
    ...
    Ext.getDom("editForm:filterString").value = valString;
    Ext.getDom("editForm:calculateFilterBtn").click();
  },
  
  reset : function() {
    Ext.getDom("editForm:filterString").value = '';
    Ext.getDom("editForm:calculateFilterBtn").click();
  },
  ...
  headerSelectionChange : function(model, selected, type) {
    ...
    if(type === 'selectPage') {
      ...
      Ext.getDom("editForm:selectAllBtn").click();
    }
    else if(type === 'deselectAll') {
      Ext.getDom("editForm:deselectAllBtn").click();
    }
  },
