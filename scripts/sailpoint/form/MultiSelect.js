...
Ext.define('SailPoint.form.MultiSelect', {
    ...
    /**
     * @cfg {boolean} True to ignore default width behavior of 300 pixels. It's the 21st century,
     *                nothing should have a set width. Come on people.
     */
    ignoreWidth : true,
    ...
    constructor: function(config) {
        ...
        if (Ext.isDefined(config.ignoreWidth)) {
            ...
            if (Object.prototype.toString.apply(value) === '[object Array]'){
                for(var i=0;i<value.length;i++){
                    ...
                    if (Object.prototype.toString.apply(o) === '[object Array]'){
                        ...
                        var record = null;
                        var recordIdx = this.comboBox.store.findExact(this.valueField, o);
                        if (recordIdx > -1)
    ...
    addRecord : function(combo, recordArr, eventOpts){
        ...
        if (this.selectionsStore.findExact(this.valueField, id) === -1){
